...
int main()
{
    std::cout << "Formatting:" << std::endl
              << "\tM/d/yy\t\t" << Date(1998, 7, 25).ToString("M/d/yy") << std::endl
              << "\tMM/dd/yyyy\t" << Date(1998, 7, 25).ToString("MM/dd/yyyy") << std::endl
              << "\tMMMM dd, yyyy\t" << Date(1998, 7, 25).ToString("MMMM dd, yyyy") << std::endl
              << "\tyyyy年M月d日\t" << Date(1998, 7, 25).ToString("yyyy年M月d日") << std::endl;
    std::cout << "Transform operations:" << std::endl
              << "\tToday:\t\t" << Date::Today().ToString() << std::endl
              << "\tTomorrow:\t" << Date::Today().AdvanceDay().ToString() << std::endl
              << "\tYesterday:\t" << Date::Today().PrevDay().ToString() << std::endl
              << "\t15 days later:\t" << Date::Today().AdvanceDay(15).ToString() << std::endl;
    std::cout << "Relation:" << std::endl
              << "\tDays to 11.11:\t\t" << Date(2019, 11, 11) - Date::Today() << std::endl
              << "\tToday after 11.11\t" << std::boolalpha << (Date::Today() > Date(2019, 11, 11)) << std::endl
              << "\tToday after 10.1\t" << std::boolalpha << (Date::Today() > Date(2019, 10, 1)) << std::endl
              << "\tToday equal to 10.26\t" << std::boolalpha << (Date::Today() == Date(2019, 10, 26)) << std::endl;
}